    ...
    return (
        <Sidebar {...props}>
            <SidebarContent className="gap-0">
                <div className="bg-white border-gray-200 pl-1.5 py-5 pr-3">
                    <div className="flex items-center gap-4">
                        <div className="flex rounded-lg border-2 min-h-10 min-w-10">
                            <Image
                                ...
                                >
                                    {selectedBrand
                                        ? <div className="flex items-center gap-2">
                                            <div className="bg-[#309E96] text-white text-xs font-semibold px-1.5 py-1 rounded">
                                                {
                        ...
                        <ChevronsLeft className="w-6 h-6 cursor-pointer text-green-primary" />
                    </div>
                </div>
                <div className="flex h-full">
                    <div className="flex flex-col bg-white h-full items-center justify-between pb-2">
                        ...
                        <div className="flex flex-col items-center gap-3">
                            ...
                            <div className="cursor-pointer bg-[#9106FF] text-white font-semibold text-xs flex items-center justify-center rounded-full h-7 w-7">
                                SS
                            </div>
                        </div>
                    </div>
